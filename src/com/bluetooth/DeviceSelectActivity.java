...
public class DeviceSelectActivity extends Activity implements Handler.Callback
{
	...
	private BluetoothControl appState;
		...
		public void onItemClick(AdapterView<?> parent, View view, int position, long id)
		{
			...
			connectionProgressDialog.setOnCancelListener(new OnCancelListener()
			{
				public void onCancel(DialogInterface di)
				{
					...
					appState.disconnect();
					if(BluetoothControl.D) Log.i(TAG, "Canceled connection progress");
					return;
				}
			});
	...
	public boolean handleMessage(Message msg)
	{
		...
		case BluetoothControl.MSG_CANCEL:
			...
			if(msg.obj != null)
			{
				...
				if(BluetoothControl.D) Log.i(TAG, "Message: " + msg.obj);
				Toast.makeText(DeviceSelectActivity.this, (String) msg.obj, Toast.LENGTH_SHORT).show();
			}
			break;
		case BluetoothControl.MSG_CONNECTED:
			// When connected to a device start the activity select
			if(BluetoothControl.D) Log.i(TAG, "Connection successful to " + msg.obj);
